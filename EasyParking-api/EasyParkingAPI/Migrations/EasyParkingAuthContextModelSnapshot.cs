...
{
    [DbContext(typeof(EasyParkingAuthContext))]
    partial class EasyParkingAuthContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("EasyParkingAPI.Model.ApplicationUser", b =>
                {
                    ...
                    b.HasIndex("NumeroDeDocumento")
                        .IsUnique()
                        .HasFilter("[NumeroDeDocumento] IS NOT NULL");
